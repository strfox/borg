...
impl Dictionary {
    ...
    pub fn rebuild_indices(&mut self) {
        ...
        self.sentences
            ...
            .flat_map(|(i, words)| std::iter::repeat(i).zip(words.into_iter()))
            .for_each(|(i, word)| insert_word_into_indices(&mut indices, &word, i));
        self.indices = indices
    }

    fn knows_sentence(&self, sentence: &String) -> bool {
        self.sentences.binary_search(&sentence).is_ok()
    }
